...
class ConvLayer(Layer): # convolutional layer of neurons
    def __init__(self, f_shape, depth, af, params, prev):
        ...
        self._w = Weights((np.prod(f_shape), depth, prev._shape[2]), af.sigma(prev._size), params) # initialise weights
        self._b = Biases(depth, params) # initialise biases
